...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_bump_debug_level, 0, ZEND_RETURN_VALUE, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_set_debug_file, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_TYPE_INFO(0, filepath, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_unset_debug_file, 0, ZEND_RETURN_VALUE, 0)
ZEND_END_ARG_INFO()

#define arginfo_chmpxpx_load_debug_env arginfo_chmpxpx_unset_debug_file

ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_load_hash_library, 0, ZEND_RETURN_VALUE, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_create, 0, 0, 2)
	...
	ZEND_ARG_TYPE_INFO(0, is_auto_rejoin, _IS_BOOL, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_destroy, 0, ZEND_RETURN_VALUE, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_msgid_open, 0, 0, 1)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_TYPE_INFO(0, no_giveup_rejoin, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_msgid_close, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(0, handle_res)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_svr_reply, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_INFO(0, handle_pxpk)
	ZEND_ARG_TYPE_INFO(0, strbinary, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_svr_reply_kv, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_INFO(0, handle_pxpk)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_slv_receive, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_INFO(0, handle_msgid)
	ZEND_ARG_INFO(1, strbinary)
	ZEND_ARG_TYPE_INFO(0, timeout_ms, IS_LONG, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_slv_receive_kv, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_INFO(0, handle_msgid)
	ZEND_ARG_INFO(1, strbinkey)
	ZEND_ARG_INFO(1, strbinval)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_slv_send, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_INFO(0, handle_msgid)
	ZEND_ARG_TYPE_INFO(0, strbinary, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, is_routing, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, is_broadcast, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_slv_send_kv, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_INFO(0, handle_msgid)
	ZEND_ARG_TYPE_INFO(0, strbinkey, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, strbinval, IS_STRING, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_chmpxpx_print_version, 0, ZEND_RETURN_VALUE, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_ChmpxServer_reply, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_TYPE_INFO(0, strbinary, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_ChmpxServer_replyKv, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_TYPE_INFO(0, strbinkey, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, strbinval, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_ChmpxServer_receive, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(1, strbinary)
	ZEND_ARG_TYPE_INFO(0, timeout_ms, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, no_giveup_rejoin, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_ChmpxServer_receiveKv, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(1, strbinkey)
	ZEND_ARG_INFO(1, strbinval)
	ZEND_ARG_TYPE_INFO(0, timeout_ms, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, no_giveup_rejoin, _IS_BOOL, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_ChmpxSlave_send, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_TYPE_INFO(0, strbinary, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, is_routing, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, is_broadcast, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_ChmpxSlave_sendKv, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_TYPE_INFO(0, strbinkey, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, strbinval, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, is_routing, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, is_broadcast, _IS_BOOL, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_ChmpxSlave_receive, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(1, strbinary)
	ZEND_ARG_TYPE_INFO(0, timeout_ms, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_ChmpxSlave_receiveKv, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_INFO(1, strbinkey)
	ZEND_ARG_INFO(1, strbinval)
	ZEND_ARG_TYPE_INFO(0, timeout_ms, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Chmpx_create, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_TYPE_INFO(0, filepath, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, is_on_server, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, is_auto_rejoin, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Chmpx_createServer, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_TYPE_INFO(0, filepath, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, is_auto_rejoin, _IS_BOOL, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Chmpx_getChmpxSlave, 0, ZEND_RETURN_VALUE, 0)
	ZEND_ARG_TYPE_INFO(0, no_giveup_rejoin, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Chmpx_getChmpxServer, 0, ZEND_RETURN_VALUE, 0)
ZEND_END_ARG_INFO()
